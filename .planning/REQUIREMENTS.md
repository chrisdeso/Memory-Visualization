...
- [x] **VIZ-03**: User sees SVG pointer arrows connecting pointer variables to their target memory locations
- [x] **VIZ-04**: User sees a registers/program state panel showing PC and SP
- [x] **VIZ-05**: User sees memory leak highlighting on heap blocks not freed before program exit
